...
//
//public class TC_39Add_ActivitiesinMore_information_of_an_Existing_contactaccording {
//
...
//		driver.findElement(By.xpath("//input[@id='jscal_field_date_start']")).sendKeys("2022-05-15");
//		driver.findElement(By.xpath("//input[@id='jscal_field_due_date']")).sendKeys(Keys.CONTROL+"a");
//		driver.findElement(By.xpath("//input[@id='jscal_field_due_date']")).sendKeys("2022-05-15");
